...
🏬 Currently at **Cooperativa Obrera**, building e-commerce platforms that handle +3M queries daily<br>
...
- ⭕ Currently developing full-stack features for [**La Coope en Casa**](https://www.lacoopeencasa.coop/) and **CoopeHogar** (PHP, Angular, SQL, Docker)
